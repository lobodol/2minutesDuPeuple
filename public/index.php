...
<aside id="social-share">
    ...
    <a href="#" title="Partager sur Facebook" id="facebookButton" target="_blank" rel="noreferrer noopener"><!--
        --><img src="<?php $asset('build/images/facebook.svg')?>" width="30" height="30" alt="Partager sur Facebook"/><!--
     --></a>
    <a href="#" title="Partager sur Twitter" id="twitterButton" target="_blank" rel="noreferrer noopener"><!--
